...
class MyAdapterBasket2(private var list: List<FoodHome>) :
    RecyclerView.Adapter<MyAdapterBasket2.ViewH>() {
...
*/
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyAdapterBasket2.ViewH {
        return ViewH(
    ...
    override fun onBindViewHolder(holder: MyAdapterBasket2.ViewH, position: Int) {
