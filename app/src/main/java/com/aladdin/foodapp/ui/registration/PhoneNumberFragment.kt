...
import com.aladdin.foodapp.databinding.FragmentPhoneNumberBinding
...
class PhoneNumberFragment : Fragment(com.aladdin.foodapp.R.layout.fragment_phone_number) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      /*      sentVerificationCode(phoneNumber)
            closeKerBoard()
            setProgress()*/
            findNavController().navigate(com.aladdin.foodapp.R.id.verificationCodeFragment)
        }
